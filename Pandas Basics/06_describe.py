#describe():It gives the summary of discriptive statistics of the numerical cloumns.
...
print("Diplay the dataframe")
print(data)
print("Displaying the summary of discriptive statistics")
print(data.describe())